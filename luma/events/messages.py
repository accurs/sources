...
class Messages(commands.Cog):
  def __init__(self, bot: Luma):
    self.bot = bot
    self.cooldown = commands.CooldownMapping.from_cooldown(3, 5, commands.BucketType.channel)
        ...
        if not cd:
          ...
          async with message.channel.typing():
            ...
            if x['data']['images']:
              ...
              file = discord.File(
                fp=io.BytesIO(videobytes),
                filename="lumatiktok.mp4"
              )
